(() => {
  ...
  function style(){
    ...
    const s=document.createElement('style');s.id='workspaceCommandStylesV1';s.textContent=`
      .workspace-command-button-v1{display:inline-flex;align-items:center;gap:7px;min-height:36px;padding:0 10px;border:1px solid #2a2a2e;border-radius:9px;background:#151517;color:#a4a4a8;cursor:pointer}.workspace-command-button-v1:hover{background:#1a1a1d;color:#f1f1ef}.workspace-command-button-v1 svg{width:15px;height:15px;fill:none;stroke:currentColor;stroke-width:1.8}.workspace-command-button-v1 span{font-size:10px;font-weight:650}.workspace-command-button-v1 kbd,.workspace-command-search-v1 kbd{font:650 7px 'JetBrains Mono',monospace;color:#77777e;padding:3px 5px;border:1px solid #2a2a2e;border-radius:5px;background:#111113}.workspace-command-v1{position:fixed;inset:0;z-index:10000}.workspace-command-v1[hidden]{display:none}.workspace-command-backdrop-v1{position:absolute;inset:0;background:rgba(0,0,0,.62);backdrop-filter:blur(5px)}.workspace-command-box-v1{position:relative;width:min(620px,calc(100vw - 28px));max-height:min(610px,80vh);margin:10vh auto 0;border:1px solid #2b2b30;border-radius:14px;background:#111113;box-shadow:0 28px 80px rgba(0,0,0,.42);overflow:hidden;animation:command-in-v1 .22s cubic-bezier(.2,.75,.2,1)}.workspace-command-search-v1{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:10px;align-items:center;padding:12px 13px;border-bottom:1px solid #25252a}.workspace-command-search-v1 svg{width:18px;height:18px;fill:none;stroke:#b8b8bc;stroke-width:1.8}.workspace-command-search-v1 input{min-height:40px!important;border:0!important;background:transparent!important;box-shadow:none!important;padding:0!important;font-size:14px}.workspace-command-list-v1{display:grid;gap:3px;padding:7px;overflow:auto;max-height:calc(min(610px,80vh) - 68px)}.workspace-command-item-v1{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:2px 12px;padding:10px 11px;border:1px solid transparent;border-radius:9px;color:inherit;text-decoration:none;transition:background .16s ease,border-color .16s ease,transform .16s ease}.workspace-command-item-v1:hover{background:#19191c;border-color:#29292e;transform:translateX(2px)}.workspace-command-route-v1{font-size:11px;font-weight:700}.workspace-command-item-v1 small{grid-column:1;font-size:9px;color:#74747b}.workspace-command-item-v1 b{grid-row:1/3;grid-column:2;align-self:center;color:#74747b;font-size:11px}.workspace-command-empty-v1{padding:24px;text-align:center;color:#74747b;font-size:10px}.workspace-command-open-v1{overflow:hidden}@keyframes command-in-v1{from{opacity:0;transform:translateY(8px) scale(.992)}to{opacity:1;transform:none}}
      @media(max-width:700px){.workspace-command-button-v1{width:36px;height:36px;padding:0;justify-content:center}.workspace-command-button-v1 span,.workspace-command-button-v1 kbd{display:none}.workspace-command-box-v1{width:calc(100vw - 18px);margin:7vh auto 0;border-radius:12px}.workspace-command-search-v1{padding:10px}.workspace-command-search-v1 kbd{display:none}.workspace-command-list-v1{padding:6px}}
