(() => {
    ...
    function install(store) {
        ...
        tools.innerHTML = `
            <label class="profile-store-search-v5"><span>Buscar</span><input type="search" placeholder="Nome, tag, moldura..." aria-label="Buscar cosmético"></label>
            <label class="profile-store-select-v5"><span>Coleção</span><select aria-label="Filtrar por coleção"><option value="all">Todas as coleções</option></select></label>
            <label class="profile-store-owned-v5"><input type="checkbox"><span>Somente adquiridos</span></label>
            <div class="profile-store-count-v5" aria-live="polite"></div>`;
    ...
    style.textContent = `
      .profile-store-tools-v5{display:grid;grid-template-columns:minmax(190px,1.3fr) minmax(150px,.7fr) auto auto;gap:9px;align-items:end;margin:0 0 14px;padding:11px;border:1px solid rgba(139,92,246,.14);border-radius:14px;background:rgba(12,8,23,.42)}
      .profile-store-search-v5,.profile-store-select-v5{display:grid;gap:5px}.profile-store-search-v5>span,.profile-store-select-v5>span{font-size:9px;color:var(--text-faint);text-transform:uppercase;letter-spacing:.07em;font-weight:700}
      .profile-store-search-v5 input,.profile-store-select-v5 select{min-height:38px!important}
      .profile-store-owned-v5{display:flex;align-items:center;gap:7px;min-height:38px;padding:0 9px;border:1px solid var(--border-soft);border-radius:10px;background:rgba(30,22,56,.42);font-size:10px;color:var(--text-muted);white-space:nowrap}.profile-store-owned-v5 input{width:auto;min-height:0}
      .profile-store-count-v5{font:700 10px 'JetBrains Mono',monospace;color:#c4b5fd;white-space:nowrap;align-self:center}
      .profile-store-collection-v5{font-size:8px;line-height:1;padding:4px 6px;border:1px solid rgba(167,139,250,.22);border-radius:999px;color:#c4b5fd;background:rgba(139,92,246,.07);white-space:nowrap;margin-left:auto}.profile-store-collection-v5.c-sakura{color:#f9a8d4;border-color:rgba(244,114,182,.26);background:rgba(190,24,93,.08)}.profile-store-collection-v5.c-developer{color:#86efac;border-color:rgba(34,197,94,.28);background:rgba(5,46,22,.18)}.profile-store-collection-v5.c-admin{color:#fde68a;border-color:rgba(250,204,21,.28);background:rgba(120,53,15,.18)}.profile-store-collection-v5.c-cosmic{color:#c4b5fd}.profile-store-collection-v5.c-holo{color:#67e8f9}.profile-store-collection-v5.c-nature{color:#bef264}
      .profile-v3-product[hidden]{display:none!important}
      @media(max-width:760px){.profile-store-tools-v5{grid-template-columns:1fr 1fr}.profile-store-owned-v5{grid-column:1/2}.profile-store-count-v5{grid-column:2/3;text-align:right}}
      @media(max-width:520px){.profile-store-tools-v5{grid-template-columns:1fr;padding:10px}.profile-store-owned-v5,.profile-store-count-v5{grid-column:auto}.profile-store-count-v5{text-align:left}.profile-store-collection-v5{font-size:7.5px}}
    `;
