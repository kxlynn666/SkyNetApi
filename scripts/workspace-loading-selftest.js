...
const postbootPos = workspace.indexOf('/workspace-postboot-v1.js?v=product-audit-1');
...
assert(postboot.includes("'/common.js?v=product-audit-1'"), 'common.js não está disponível no pós-boot das páginas normais.');
...
assert(postboot.includes("'/workspace-feature-loader-v1.js?v=product-audit-1'"), 'Feature loader auditado não está no pós-boot.');
...
assert(featureLoader.includes('/profile-studio-v1.js?v=1'), 'Profile Studio não está no feature loader.');
assert(featureLoader.includes('/system-status-v1.js?v=1'), 'Status não está no feature loader.');
...
console.log('Workspace loading self-test OK (boot mínimo + ferramentas leves + Studio)');
